    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex justify-center items-center p-4">
      <div className="w-full max-w-md bg-white shadow-lg rounded-xl p-8 border border-slate-200">
        <div className="text-center mb-6">
          ...
          <p className="text-slate-600 text-sm">Start creating professional invoices in minutes</p>
        </div>
        ...
        <form action={formAction} className="space-y-4">
          ...
          {/* NEED to add sign-up with google here as well */}
          ...
          <Button
            variant="secondary"
            type="button"
            className="w-full p-3 text-sm font-medium flex items-center justify-center gap-2"
